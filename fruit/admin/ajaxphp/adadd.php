	...
	?>
        ...
        <form class="form-horizontal" style="padding:0 20px;" id="addform">
            ...
            <div class="control-group">
                 ...
                 <div class="controls">
                   <input type="url" class="input-xxlarge" id="linkurl" name="linkurl" placeholder="链接" />
                 </div>
            </div>
            <div class="control-group">
                 ...
                 <div class="controls controls-row">
                   ...
                   <div class="span4" style="padding:6px 0 0" id="imgupload_preview"></div>
                 </div>
            </div>
        ...
        $(document).ready(function(){
			...
			$("#submitbtn").click(function() {
				...
				$.post("ajaxphp/adsubmit.php",$('#addform').serialize(),function(callback) {
					$.dialog({
						title: "消息",
